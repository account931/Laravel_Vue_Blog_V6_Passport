...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
		...
		//$this->call('Roles_Seeder');  //fill DB table {roles} with data {4 roles}, Entrust
		//$this->call('RoleUsers_Seeder');  //fill DB table {role_user} with data {assign admin to Dima}, Entrust
...
//fill DB table {roles} with data (create 4 roles), Entrust
/*
...
//fill DB table {role_user} with data, Entrust
/*
