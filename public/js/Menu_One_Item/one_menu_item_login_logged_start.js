...
Vue.component('menu-one-item', __webpack_require__(319)); //components containing menu with (login/logged) switch
...
var render = function() {
  ...
  return _c("span", [
    _vm._v(
      "  " +
        _vm._s(
          _vm.ifPassportTokenSet == null ? "LogginX" : "LoggedX-Dashboard"
        ) +
        " "
    )
  ])
