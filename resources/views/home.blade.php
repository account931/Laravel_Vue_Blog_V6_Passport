            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="panel-body">
                        ...
                        <p> <i class="fa fa-check-circle-o" style="font-size:24px"></i> Axios, Fetch or $.ajax({}) requests (working variants for all of them) </p>
                        ...
                        <p> <i class="fa fa-check-circle-o" style="font-size:24px"></i> {Laravel_Vue_Blog_V6_Passport} => Login/password/register + all requests via REST API, auth via Passport Bearer token. Following is True only for prev{Laravel_Vue_Blog} => Login/password auth via session, REST API auth via Bearer token. </p>
                        <p> <i class="fa fa-check-circle-o" style="font-size:24px"></i> Rest Api uses middleware 'myJsonForce' to return JSON</p>
                        <p> <i class="fa fa-check-circle-o" style="font-size:24px"></i> {Laravel_Vue_Blog_V6_Passport} uses Passport token stored hashed in table {oauth_access_tokens`}. Following is True only for prev{Laravel_Vue_Blog} =>  Token is User's table 'api_token' field. </p>
                        <p> <i class="fa fa-check-circle-o" style="font-size:24px"></i> Following is True only for prev{Laravel_Vue_Blog} => Admin Part is protected with Zizaco/Entrust JSON middleware and available for users with Admin rights only </p>
